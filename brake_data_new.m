...
speed = [velocity_brake0, velocity_brake10, velocity_brake40, velocity_brake50, velocity_brake60, velocity_brake70,...
        velocity_brake80, velocity_brake90, velocity_brake100];
acceleration = [acceleration0, acceleration_brake10, acceleration_brake40, acceleration_brake50, acceleration_brake60, acceleration_brake70,...
                acceleration_brake80, acceleration_brake90, acceleration_brake100];
brake0 = 0*ones(size(acceleration0));
brake10 = -10*ones(size(acceleration_brake40));
...
brake = [brake0, brake10, brake40 brake50, brake60, brake70, brake80, brake90, brake100];
brake1 = 0.01*brake;
