...
for i in range(len(listdir_)):
	...
	try:	
		...
		p6 = figure(title=listdir_[i], x_axis_label='time (sec)', y_axis_label='slope')
		p6.line(data_[long_ndx][:,0], slope1, legend="Slope",line_width=2, line_color="purple")

		curr = gridplot([[p1, p3, p4, p5, p6]])
		show(curr)
